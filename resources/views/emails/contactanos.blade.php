...
<html lang="en">
    ...
    <body>
        ...
        <table width='700' height='222' border='0' align='center' cellpadding='5' cellspacing='0'>
            <tr>
                <td width='700' align='center' valign='middle'>
                    <img src="https://grupotyg.pe/img/iso-1.png" width='200' height='200' />
                </td>
            </tr>
            <tr>
        ...
        <table width='700' border='1' cellpadding='8' cellspacing='0' align='center'>
            ...
            <tr>
                <td align='center' colspan="1" style='font-weight:bold'>Servicio</td>
                <td align='center'>{{$contacto['servicio']}}</td>
            </tr>
            <tr>
