...
<div class="container-fluid page-header py-5">
    <div class="container text-center py-5">
        <h1 class="display-2 text-white mb-4 animated slideInDown">{{$service->name}}</h1>
        ...
        <div class="row g-5">
            <div class="col-lg-5 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".3s">
                <div class="h-100 position-relative">
                    <img src="{{config('url')}}/storage/{{$service->image}}" class="img-fluid rounded" alt="" style="margin-bottom: 25%;">
...
<div class="container-fluid my-5">
    <div class="container">
        <div class="text-center mx-auto pb-5 wow fadeIn mb-4" data-wow-delay=".3s" style="max-width: 600px;">
            <h5 class="text-primary">Nuesatros recientes proyectos</h5>
            <h1>Portafolio</h1>
        </div>
        <div class="row g-5">
            <div class="m-p-g">
